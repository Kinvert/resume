...
void hit();
  ...
  static volatile char oranh, orant;
...
int main()                                    // Main function
{
  ...
  while(1)
  {
    ...
    xchar = fdserial_rxChar( xbee );    //skip blue turret
    orant = fdserial_rxChar( xbee );    //get orange turret
    
    xchar = fdserial_rxTime( xbee, 10 );//skip blue health
    fdserial_txChar( xbee, oranh );     //send orange health
